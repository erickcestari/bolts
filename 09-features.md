...
| 38/39 | `option_onion_messages`           | Can forward onion messages to/from any connected peer     | IN       |                             | [BOLT #7](04-onion-routing.md#onion-messages)                         |
...
| 66/67 | `option_onion_messages_channel_only` | Restricts onion message forwarding to channel peers only  | IN       | `option_onion_messages`     | [BOLT #7](04-onion-routing.md#onion-messages)                         |
